...
String helpers = '''    com.google.firebase.firestore.ListenerRegistration adminNotificationListener;
...
if "void createAdminNotification(String type,String itemId" not in s:
    s=s.replace("    void installBackHandler()",helpers+"    void initAdminNotifications(){}",1)
