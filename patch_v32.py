...
const marker='    void runOcr(Uri u)';
const helpers='''    Task<List<String>> encodeImagesForFirestoreAsync(){
...
const tail='p.write_text(s,encoding="utf-8")\nprint("TARGETED V32 PATCH OK")';
if(!s.includes(tail)) throw new Error("patch_v32 tail not found");
